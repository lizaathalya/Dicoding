...
# --------------------- Pertanyaan 2 ---------------------
st.subheader("📦 **Apakah kategori produk memengaruhi jumlah pesanan?**")
...
# Menyesuaikan kolom
category_analysis.columns = ['product_category_name_english', 'order_count']
...
ax2.barh(category_analysis['product_category_name_english'], category_analysis['order_count'], color='lightgreen')
